...
function AdminAccounts() {
	...
	function getAccounts() {
		axios.get("http://localhost:8080/account/get-by-role", { params: { role: "ROLE_USER" } })
			.then((response) => {
		...
		<>
			...
			<main className='registrations-page admin-page'>
				<div className="registrations-page__container admin-page__container">
					<h1 className="registrations-page__title admin-page__title">Аккаунты посетителей</h1>
					<Link to={"/admin"}>
