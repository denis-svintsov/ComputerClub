...
function AccountActives() {
	...
	useEffect(() => {
		setIsLoading(true);
		axios.get("http://localhost:8080/registration/get-actives", { params: { id: AuthService.getCurrentUser().id } })
			.then((response) => {
			...
			<main className='account-page main-page'>
				<div className="account-page main-page__header main-header">
					<div className="account-page__body">
						<h1 className='account-page__title'>Записи</h1>
						<Link to={"../"}>
