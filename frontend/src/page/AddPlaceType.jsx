		...
		<>
			...
			<main className='places-page admin-page'>
				<div className="places-page__container admin-page__container">
					<h1 className="places-page__title admin-page__title">Добавление типа места</h1>
					<Link to={"/admin"}>
					...
					<div className="places-page__body admin-page__body">
						<div className="form-control">
							...
							<input className='form__input registration__input' type="text" id='place-type' value={name} onChange={(e) => { setName(e.target.value) }} />
						</div>
